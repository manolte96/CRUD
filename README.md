...
INSERT INTO users (first_name, last_name, id) VALUES ('test', 'user', 501) 

INSERT INTO users (first_name, last_name, id) VALUES ('test2', 'user', 502)
...
DELETE FROM usersContact, usersAddress, users
      WHERE id = 114
